Contributing to BitCanna
============================

The BitCanna project operates an open contributor model where anyone is
...
The following applies to code changes to the BitCanna project, and is not to be
confused with overall BCNA Network Protocol consensus changes.

Whether a pull request is merged into BitCanna rests with the project merge
...
Patches that change BCNA consensus rules are considerably more involved than
...
Where a patch set proposes to change the BCNA consensus, it must have been
...
The project leader is the release manager for each BitCanna release.
