...
/** Utility functions used by the BCNA Qt UI.
 */
namespace GUIUtil
{
...
// Render BCNA addresses in monospace font
...
// Parse "bitcanna:" URI into recipient object, return true on successful parsing
