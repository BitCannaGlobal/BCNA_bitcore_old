...
RESOURCES += src/qt/bitcanna.qrc src/qt/bitcanna_locale.qrc

TRANSLATIONS += src/qt/locale/bitcanna_bg.ts \
                src/qt/locale/bitcanna_de.ts \
                src/qt/locale/bitcanna_en.ts \
                src/qt/locale/bitcanna_es.ts \
                src/qt/locale/bitcanna_fi.ts \
                src/qt/locale/bitcanna_fr.ts \
                src/qt/locale/bitcanna_it.ts \
                src/qt/locale/bitcanna_ja.ts \
                src/qt/locale/bitcanna_pl.ts \
                src/qt/locale/bitcanna_pt.ts \
                src/qt/locale/bitcanna_ru.ts \
                src/qt/locale/bitcanna_sk.ts \
                src/qt/locale/bitcanna_sv.ts \
                src/qt/locale/bitcanna_vi.ts \
                src/qt/locale/bitcanna_zh_CN.ts \
                src/qt/locale/bitcanna_zh_TW.ts
