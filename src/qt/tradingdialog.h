...
#ifndef BCNA_TRADINGDIALOG_H
#define BCNA_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfBCNAOnTradingTab();
    ...
    void showBalanceOfBCNAOnSendTab();
    void showBalanceOfBCNAOnBalanceTab();
    ...
    QString BuyBCNA(QString OrderType, double Quantity, double Rate);
    QString SellBCNA(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"BCNA/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"BCNA/BTC\"}"));// "{\"gender\":\"male\"}");
