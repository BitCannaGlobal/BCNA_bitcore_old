...
Explore
 ...
 Sign out
 Unwatch 2
  Star 0  Fork 26 duzy/bitcanna
forked from 216k155/bitcanna
 Code  Pull requests 0  Projects 0  Wiki  Insights
Branch: merging-master… Find file Copy pathbitcanna/build-aux/m4/bitcoin_qt.m4
98a328a  2 days ago
...
AC_DEFUN([BITCOIN_QT_FAIL],[
  if test "x$bitcoin_qt_want_version" = xauto && test "x$bitcoin_qt_force" != xyes; then
    if test "x$bitcoin_enable_qt" != xno; then
      AC_MSG_WARN([$1; bitcanna-qt frontend will not be built])
    fi
...
AC_DEFUN([BITCOIN_QT_INIT],[
  ...
  AC_ARG_WITH([gui],
    ...
    [build bitcanna-qt GUI (default=auto, qt5 tried first)])],
    [
