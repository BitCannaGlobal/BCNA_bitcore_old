...
In order to support loading of multiple wallets in bitcanna-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcanna.cpp.
...
Changes to bitcanna.cpp
----------------------
bitcanna.cpp is the entry point into bitcanna-qt, and as such, will require some minor modifications to provide hooks for
