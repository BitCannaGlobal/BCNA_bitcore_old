...
This means one can have an always-on bitcannad instance running, and another local bitcannad/bitcanna-qt instance which connects to this node and receives blocks from it.
