...
void BaseTableDelegate::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    ...
    const int lastColIndex = this->lastColumnIndex;
    int leftBgMargin = 16;
    ...
    if (index.column() == 0) {
        ...
        leftBgMargin = this->lastColumnBgMargin;
    }
