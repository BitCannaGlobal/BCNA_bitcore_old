...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitCanna features */
        {"bitcanna", "masternode", &masternode, true, true, false},
        //{"bitcanna", "masternodelist", &masternodelist, true, true, false},
        //{"bitcanna", "mnbudget", &mnbudget, true, true, false},
        //{"bitcanna", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"bitcanna", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"bitcanna", "mnsync", &mnsync, true, true, false},
        {"bitcanna", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"bitcanna", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcannad, or the -server option to bitcanna-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcanna-cli " + methodname + " " + args + "\n";
}
