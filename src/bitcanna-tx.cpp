...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitCanna bitcanna-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcanna-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcanna transaction") + "\n" +
                               "  bitcanna-tx [options] -create [commands]   " + _("Create hex-encoded bitcanna transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcanna transaction
