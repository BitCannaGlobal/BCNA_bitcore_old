...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("BitCanna RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  bitcanna-cli [options] <command> [params]  " + _("Send command to BitCanna") + "\n" +
                        "  bitcanna-cli [options] help                " + _("List commands") + "\n" +
                        "  bitcanna-cli [options] help <command>      " + _("Get help for a command") + "\n";
