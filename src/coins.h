...
/** 
    ...
    ****Note - for BCNA we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of bitcanna coming in to a transaction
