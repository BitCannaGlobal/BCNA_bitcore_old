                                              ...
                                              filter(0)
{
    ...
    if (fLiteMode) {
        ...
        if (fMasterNode) {
            ...
            if (!fEnableBitCannasend) {
                ui->toggleObfuscation->setText(tr("Start BitCannasend"));
            } else {
                ui->toggleObfuscation->setText(tr("Stop BitCannasend"));
            }
...
void SmartContractPage::toggleObfuscation()
{
    ...
    fEnableBitCannasend = !fEnableBitCannasend;
    obfuscationPool.cachedNumBlocks = std::numeric_limits<int>::max();
