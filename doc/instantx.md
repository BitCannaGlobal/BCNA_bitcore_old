...
This mechanism has been integrated into Bitcore-Node-BCNA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BCNA-Project/insight-api-bitcanna#web-socket-api](https://github.com/BCNA-Project/insight-api-bitcanna#web-socket-api) 
* API: [https://github.com/BCNA-Project/insight-api-bitcanna#instantx-transactions](https://github.com/BCNA-Project/insight-api-bitcanna#instantx-transactions)
...
By default, the BitCanna daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitCanna daemon:
