...
//            return QString::fromUtf8("μBCNA");
        ...
        switch (unit) {
        case BCNA:
            return QString("tBCNA");
//        case mBCNA:
//            return QString("mtBCNA");
//        case uBCNA:
//            return QString::fromUtf8("μtBCNA");
        default:
            return QString("???");
        }
    }
...
//            return QString("Micro-BCNA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        ...
        switch (unit) {
        case BCNA:
            return QString("TestBCNAs");
//        case mBCNA:
//            return QString("Milli-TestBCNA (1 / 1" THIN_SP_UTF8 "000)");
//        case uBCNA:
//            return QString("Micro-TestBCNA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
