...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOTMN = 4, // ONLY_NONDENOMINATED_NOT10000IFMN = 4, ONLY_NONDENOMINATED and not 10000 BCNA at the same time
};
...
public:
    ...
    std::map<std::string, CBitCannaNodeConfig> mapMyBitCannaNodes;
    bool AddBitCannaNodeConfig(CBitCannaNodeConfig nodeConfig);
